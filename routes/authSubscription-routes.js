...
module.exports = function (app) {
  app.post("/create-subscription-authorize", (req, res) => {
    ...
    nameAndAddressType.setFirstName(req.body.fname?req.body.fname:req.body.user.fname);
    nameAndAddressType.setLastName(req.body.lname?req.body.lname:req.body.user.lname);
    nameAndAddressType.setCompany(req.body.category?req.body.category:req.body.user.category);
    nameAndAddressType.setAddress(req.body.streetAddressLine1?req.body.streetAddressLine1:req.body.user.streetAddressLine1);
    nameAndAddressType.setCity(req.body.city?req.body.city:req.body.user.city);
    nameAndAddressType.setState(req?.body?.stateOrProvince?req?.body?.stateOrProvince:req?.body?.user?.stateOrProvince);
    nameAndAddressType.setZip(req.body.postalCode?req.body.postalCode:req.body.user.postalCode);
    nameAndAddressType.setCountry(req.body.country?req.body.country:req.body.user.country);

    var arbSubscription = new ApiContracts.ARBSubscriptionType();
    arbSubscription.setName(req.body.fname?req.body.fname:req.body.user.fname);
